    ...
    <div className="app" style={{ height: `${screenHeight}px` }}>
      <div className="desktop" style={{ height: `${screenHeight}px` }}>
        ...
        <div className="second-container-desktop">
          ...
          <img src="/WB-MOBILE-VERSION_0011_Switch-to-button.png" alt="Switch to World Book" className="switch-btn-desktop" />
      ...
      <div className="mobile" style={{ height: `${screenHeight}px` }}>
        ...
        <div className="second-container">
          ...
          <img src="/WB-MOBILE-VERSION_0011_Switch-to-button.png" alt="Switch to World Book" className="switch-btn" />
